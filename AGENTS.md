...
- 对话历史管理、知识库管理、维护者在线上传、MinIO 私有原件与版本 Chunk、Redis 入库 Worker、Qdrant/BM25 版本化索引、受协调锁保护的原子版本发布、幂等重投递、过期任务恢复、暂存清理、五项就绪检查、上传接受审计和安全逻辑撤回已实现；维护者手工重试、下载和永久物理清理尚未实现。
